       ...
       <div class="row">
          <div class="col-lg-3 col-sm-6">
             <div class="counter-box">
                ...
                <div class="counter-content">
                   <span class="counter" data-count="+" data-to="1000" data-speed="1000">1000</span>
          ...
          <div class="col-lg-3 col-sm-6">
             <div class="counter-box mt-40">
                ...
                <div class="counter-content">
                   <span class="counter" data-count="+" data-to="100" data-speed="100">100</span>
          ...
          <div class="col-lg-3 col-sm-6">
             <div class="counter-box">
                ...
                <div class="counter-content">
                   <span class="counter" data-count="+" data-to="3000" data-speed="3000">3000</span>
          ...
          <div class="col-lg-3 col-sm-6">
             <div class="counter-box mt-40">
                ...
                <div class="counter-content">
                   <span class="counter" data-count="+" data-to="50" data-speed="50">50</span>
